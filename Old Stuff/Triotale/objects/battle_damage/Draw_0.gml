...
if(damage<=0){
	...
	draw_sprite_ext(spr_battle_damage_blocked,0,xstart,y,1,1,0,c_gray,1);
	}else if(miss_type = 3){
	draw_sprite_ext(spr_battle_damage_parry,0,xstart,y,1,1,0,c_gray,1);
	}else if(miss_type = 4){
	draw_sprite_ext(spr_battle_damage_nd,0,xstart,y,1,1,0,c_gray,1);
	}
}else{
	if(miss_type<=0){
