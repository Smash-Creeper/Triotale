...
//draw_sprite_pos(spr_battle_techno,2,RCAPECORNER_X1,RCAPECORNER_Y1,RCAPECORNER_X2,RCAPECORNER_Y2,RCAPECORNER_X3,RCAPECORNER_Y3,RCAPECORNER_X4,RCAPECORNER_Y4,1)
	...
	break;
		case 1:
		draw_sprite_pos_ext(spr_battle_tommy,4,x,y,-44,-14,44,-14,44,0,-44,0,0,c_white,1)
		draw_sprite_pos_ext(spr_battle_tommy,3,x-6,y,-32,-12-90,+32,-12-90,+32,(-12)-0,-32,(-12)-0,0,c_white,1)
		draw_sprite_ext(spr_battle_tommy,2,x,y,2,2,0,c_white,1)
		draw_sprite_ext(spr_battle_tommy,2,x,y,2,2,0,c_white,1)
		draw_sprite_ext(spr_battle_tommy,1,x,y,2,2,0,c_white,1)
	break;
	case 2:
		{
	var BODY_X = sin(siner1/60) * 6
